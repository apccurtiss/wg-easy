...
module.exports.WG_DEFAULT_ADDRESS = process.env.WG_DEFAULT_ADDRESS || '10.8.0.0/24';
...
iptables -t nat -D POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS} -o ${module.exports.WG_DEVICE} -j MASQUERADE;
